...
mod tests {
    ...
    fn test_cpu_detection() {
        ...
        assert!(matches!(cpu_info.vendor, CpuVendor::Intel | CpuVendor::Amd | CpuVendor::Arm | CpuVendor::Unknown));
    ...
    fn test_gemm_tile_size() {
        ...
        println!("GEMM tile size: {}x{}x{}", m, n, k);
    }
    ...
    fn test_total_memory_estimation() {
        ...
        println!("Estimated total memory: {} MB", total_memory);
    }
